...
class TensorboardWriter:
    def __init__(self, log_dir: str, *args: Any, **kwargs: Any):
        ...
        :param log_dir: Save directory location. Will not write to disk if log_dir is an empty string.
        :param args: Additional positional args for SummaryWriter
        :param kwargs: Additional keyword args for SummaryWriter
        """
    ...
    def add_video_from_np_images(
        ...
        :param images: list of n frames. Each frame is a np.ndarray of shape.
