...
class SyncVectorEnv:
    ...
    def __init__(
        ...
        """
        Create an object of a class for creating a syncrhonized vector environment
    ...
    def pause_at(self, index: int) -> None:
        ...
        :param index: which env to pause. All indexes after this one will be shifted down by one.
        :return: None
    ...
    def call_at(
        ...
        :param function_args: result of calling the function.
        :return: result
        """
    ...
    def call(
        ...
        :param function_args_list: list of function args for each function. If provided, :py:`len(function_args_list)`
                                    should be as long as :py:`len(function_names)`.
